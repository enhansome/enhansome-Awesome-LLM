...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,467 | 🐛 242 | 🌐 Python | 📅 2025-08-28 - First open-sourced GPT-4o level model.
* [DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ⭐ 91,982 | 🐛 34 | 📅 2025-06-27 - First-generation reasoning models from DeepSeek.
* [open-r1](https://github.com/huggingface/open-r1) ⭐ 26,471 | 🐛 340 | 🌐 Python | 📅 2026-04-02 - Fully open reproduction of DeepSeek-R1
* [TinyZero](https://github.com/Jiayi-Pan/TinyZero) ⭐ 13,237 | 🐛 82 | 🌐 Python | 📅 2026-02-27 - Clean, minimal, accessible reproduction of DeepSeek R1-Zero
* [Kimi-K2](https://github.com/MoonshotAI/Kimi-K2) ⭐ 11,121 | 🐛 72 | 📅 2026-01-21 - MoE language model with 32B active and 1T total parameters.
...
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,665 | 🐛 78 | 🌐 HTML | 📅 2026-09-09 - A collection of prompt examples to be used with the ChatGPT model.

* [awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ⭐ 62,473 | 🐛 45 | 📅 2026-04-28 - A Chinese collection of prompt examples to be used with the ChatGPT model.
...
* [Awesome ChatGPT](https://github.com/humanloop/awesome-chatgpt) ⭐ 8,204 | 🐛 149 | 📅 2025-10-15 - Curated list of resources for ChatGPT and GPT-3 from OpenAI.
...
* [Reasoning using Language Models](https://github.com/atfortes/LM-Reasoning-Papers) ⭐ 3,686 | 🐛 27 | 📅 2026-04-20 - Collection of papers and resources on Reasoning using Language Models.

* [LLMDatahub](https://github.com/Zjh-819/LLMDataHub) ⭐ 3,414 | 🐛 5 | 📅 2023-11-28 - a curated collection of datasets specifically designed for chatbot training, including links, size, language, usage, and a brief description of each dataset
...
* [Chinese Large Model Leaderboard](https://github.com/jeinlee1991/chinese-llm-benchmark) ⭐ 6,445 | 🐛 18 | 📅 2026-09-17 - an expert-driven benchmark for Chineses LLMs.
...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,467 | 🐛 242 | 🌐 Python | 📅 2025-08-28
* [DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ⭐ 91,982 | 🐛 34 | 📅 2025-06-27
* [DeepSeek-Coder-v2-16|236B-MOE](https://github.com/deepseek-ai/DeepSeek-Coder-V2) ⭐ 7,014 | 🐛 78 | 📅 2025-11-11
...
* [Pythia-1|1.4|2.8|6.9|12B](https://github.com/EleutherAI/pythia) ⭐ 2,935 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-11-15
...
> Reference: [LLMDataHub](https://github.com/Zjh-819/LLMDataHub) ⭐ 3,414 | 🐛 5 | 📅 2023-11-28

* [Datatrove](https://github.com/huggingface/datatrove) ⭐ 3,341 | 🐛 105 | 🌐 Python | 📅 2026-09-17 - Freeing data processing from scripting madness by providing a set of platform-agnostic customizable pipeline processing blocks.
* [IBM data-prep-kit](https://github.com/IBM/data-prep-kit) ⭐ 963 | 🐛 231 | 🌐 HTML | 📅 2026-09-08 - Open-Source Toolkit for Efficient Unstructured Data Processing with Pre-built Modules and Local to Cluster Scalability.
* [Dingo](https://github.com/DataEval/dingo) ⭐ 757 | 🐛 6 | 🌐 Python | 📅 2026-09-17 - Dingo: A Comprehensive Data Quality Evaluation Tool
...
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 14,017 | 🐛 995 | 🌐 Python | 📅 2026-09-14 - A framework for few-shot evaluation of language models.
* [simple-evals](https://github.com/openai/simple-evals) ⭐ 4,636 | 🐛 62 | 🌐 Python | 📅 2026-04-22 - Eval tools by OpenAI.
* [lighteval](https://github.com/huggingface/lighteval) ⭐ 2,545 | 🐛 411 | 🌐 Python | 📅 2026-09-17 - a lightweight LLM evaluation suite that Hugging Face has been using internally.

<details>
<summary>other evaluation frameworks</summary>

* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,765 | 🐛 596 | 🌐 Python | 📅 2026-02-24 - a framework that helps you evaluate your Retrieval Augmented Generation (RAG) pipelines.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,824 | 🐛 66 | 🌐 Python | 📅 2026-09-18 - Testing & evaluation library for LLM applications, in particular RAGs
* [HELM](https://github.com/stanford-crfm/helm) ⭐ 2,913 | 🐛 105 | 🌐 Python | 📅 2026-09-01 - Holistic Evaluation of Language Models (HELM), a framework to increase the transparency of language models.
...
* [OLMO-eval](https://github.com/allenai/OLMo-Eval) ⭐ 70 | 🐛 67 | 🌐 Python | 📅 2026-09-18 - a repository for evaluating open language models.
...
* [DeepSpeed](https://github.com/microsoft/DeepSpeed) ⭐ 43,133 | 🐛 1,441 | 🌐 Python | 📅 2026-09-18 - DeepSpeed is a deep learning optimization library that makes distributed training and inference easy, efficient, and effective.
* [Megatron-LM](https://github.com/NVIDIA/Megatron-LM) ⭐ 17,940 | 🐛 1,367 | 🌐 Python | 📅 2026-09-18 - Ongoing research training transformer models at scale.
* [Litgpt](https://github.com/Lightning-AI/litgpt) ⭐ 13,668 | 🐛 290 | 🌐 Python | 📅 2026-09-14 - 20+ high-performance LLMs with recipes to pretrain, finetune and deploy at scale.
* [torchtitan](https://github.com/pytorch/torchtitan) ⭐ 5,747 | 🐛 729 | 🌐 Python | 📅 2026-09-18 - A native PyTorch Library for large model training.
* [Meta Lingua](https://github.com/facebookresearch/lingua) ⭐ 4,766 | 🐛 14 | 🌐 Python | 📅 2025-07-18 - a lean, efficient, and easy-to-hack codebase to research LLMs.
...
* [unslothai](https://github.com/unslothai/unsloth) ⭐ 76,376 | 🐛 1,238 | 🌐 Python | 📅 2026-09-18 - A framework that specializes in efficient fine-tuning. On its GitHub page, you can find ready-to-use fine-tuning templates for various LLMs, allowing you to easily train your own data for free on the Google Colab cloud.
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI) ⭐ 41,441 | 🐛 504 | 🌐 Python | 📅 2026-09-18 - Making large AI models cheaper, faster, and more accessible.
* [veRL](https://github.com/volcengine/verl) ⭐ 23,487 | 🐛 1,231 | 🌐 Python | 📅 2026-09-18 - veRL is a flexible and efficient RL framework for LLMs.
* [NeMo Framework](https://github.com/NVIDIA/NeMo) ⭐ 18,473 | 🐛 315 | 🌐 Python | 📅 2026-09-18 - Generative AI framework built for researchers and PyTorch developers working on Large Language Models (LLMs), Multimodal Models (MMs), Automatic Speech Recognition (ASR), Text to Speech (TTS), and Computer Vision (CV) domains.
* [Axolotl](https://github.com/axolotl-ai-cloud/axolotl) ⭐ 12,486 | 🐛 240 | 🌐 Python | 📅 2026-09-18 - Open-source framework for fine-tuning and evaluating LLMs. It simplifies the process of experimenting with different training configurations and makes it easy to reproduce and share results, supporting features like LoRA, QLoRA, DeepSpeed, PEFT, and multi-GPU setups.
* [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 10,015 | 🐛 380 | 🌐 Python | 📅 2026-09-17 - An Easy-to-use, Scalable and High-performance RLHF Framework (70B+ PPO Full Tuning & Iterative DPO & LoRA & RingAttention & RFT).
* [GPT-NeoX](https://github.com/EleutherAI/gpt-neox) ⭐ 7,461 | 🐛 120 | 🌐 Python | 📅 2026-09-04 - An implementation of model parallel autoregressive transformers on GPUs, based on the DeepSpeed library.
* [torchtune](https://github.com/pytorch/torchtune) ⭐ 5,812 | 🐛 467 | 🌐 Python | 📅 2026-09-09 - A Native-PyTorch Library for LLM Fine-tuning.
* [Transformer Engine](https://github.com/NVIDIA/TransformerEngine) ⭐ 3,540 | 🐛 361 | 🌐 Python | 📅 2026-09-18 - A library for accelerating Transformer model training on NVIDIA GPUs.
* [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,401 | 🐛 133 | 🌐 Python | 📅 2026-09-18 - An Efficient and User-Friendly Scaling Library for Reinforcement Learning with Large Language Models.
* [maxtext](https://github.com/AI-Hypercomputer/maxtext) ⭐ 2,421 | 🐛 304 | 🌐 Python | 📅 2026-09-18 - A simple, performant and scalable Jax LLM!
...
* [ollama](https://github.com/ollama/ollama) ⭐ 181,219 | 🐛 4,034 | 🌐 Go | 📅 2026-09-18 - Get up and running with Llama 3, Mistral, Gemma, and other large language models.
* [llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 128,703 | 🐛 2,497 | 🌐 C++ | 📅 2026-09-18 - LLM inference in C/C++.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 92,110 | 🐛 8,116 | 🌐 Python | 📅 2026-09-18 - A high-throughput and memory-efficient inference and serving engine for LLMs.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 36,141 | 🐛 5,467 | 🌐 Python | 📅 2026-09-18 - SGLang is a fast serving framework for large language models and vision language models.
* [TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) ⭐ 14,653 | 🐛 1,515 | 🌐 Python | 📅 2026-09-18 - Nvidia Framework for LLM Inference
...
* [FastChat](https://github.com/lm-sys/FastChat) ⭐ 39,539 | 🐛 1,043 | 🌐 Python | 📅 2026-05-01 - A distributed multi-model LLM serving system with web UI and OpenAI-compatible RESTful APIs.
* [OpenLLM](https://github.com/bentoml/OpenLLM) ⭐ 12,538 | 🐛 17 | 🌐 Python | 📅 2026-09-14 - Fine-tune, serve, deploy, and monitor any open-source LLMs in production. Used in production at [BentoML](https://bentoml.com/) for LLMs-based applications.
* [SkyPilot](https://github.com/skypilot-org/skypilot) ⭐ 10,618 | 🐛 432 | 🌐 Python | 📅 2026-09-18 - Run LLMs and batch jobs on any cloud. Get maximum cost savings, highest GPU availability, and managed execution -- all with a simple interface.
* [LMDeploy](https://github.com/InternLM/lmdeploy) ⭐ 8,081 | 🐛 595 | 🌐 Python | 📅 2026-09-18 - A high-throughput and low-latency inference and serving framework for LLMs and VLs
* [mistral.rs](https://github.com/EricLBuehler/mistral.rs) ⭐ 7,703 | 🐛 383 | 🌐 Rust | 📅 2026-09-08 - Blazingly fast LLM inference.
* [Liger-Kernel](https://github.com/linkedin/Liger-Kernel) ⭐ 6,618 | 🐛 224 | 🌐 Python | 📅 2026-09-17 - Efficient Triton Kernels for LLM Training.
...
* [Text-Embeddings-Inference](https://github.com/huggingface/text-embeddings-inference) ⭐ 5,056 | 🐛 205 | 🌐 Rust | 📅 2026-09-17 - Inference for text-embeddings in Rust, HFOIL Licence.
...
* [Infinity](https://github.com/michaelfeil/infinity) ⭐ 2,942 | 🐛 136 | 🌐 Python | 📅 2026-03-24 - Inference for text-embeddings in Python
...
> Reference: [awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) ⭐ 138,824 | 🐛 19 | 🌐 Python | 📅 2026-09-16

* [LangChain](https://github.com/hwchase17/langchain) ⭐ 146,601 | 🐛 531 | 🌐 Python | 📅 2026-09-18 — A popular Python/JavaScript library for chaining sequences of language model prompts.
* [LlamaIndex](https://github.com/jerryjliu/llama_index) ⭐ 52,213 | 🐛 802 | 🌐 Python | 📅 2026-09-18 — A Python library for augmenting LLM apps with data.
* [dspy](https://github.com/stanfordnlp/dspy) ⭐ 38,120 | 🐛 707 | 🌐 Python | 📅 2026-09-18 - DSPy: The framework for programming—not prompting—foundation models.

<details>
<summary>more applications</summary>

* [Dify](https://github.com/langgenius/dify) ⭐ 156,320 | 🐛 1,106 | 🌐 TypeScript | 📅 2026-09-18 - An open-source LLM app development platform with an intuitive interface that streamlines AI workflows, model management, and production deployment.

* [Embedchain](https://github.com/embedchain/embedchain) ⭐ 65,594 | 🐛 756 | 🌐 Python | 📅 2026-09-18 - Framework to create ChatGPT like bots over your dataset.

* [Langchain-Chatchat](https://github.com/chatchat-space/Langchain-Chatchat) ⭐ 38,644 | 🐛 26 | 🌐 Python | 📅 2025-11-10 - Formerly langchain-ChatGLM, local knowledge based LLM (like ChatGLM) QA app with langchain.

* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,782 | 🐛 908 | 🌐 TypeScript | 📅 2026-09-18 -  Open Source LLM Engineering Platform 🪢 Tracing, Evaluations, Prompt Management, Evaluations and Playground.

* [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,575 | 🐛 307 | 🌐 C# | 📅 2026-09-18 — A Python/C#/Java library from Microsoft that supports prompt templating, function chaining, vectorized memory, and intelligent planning.

* [promptfoo](https://github.com/typpo/promptfoo) ⭐ 25,266 | 🐛 637 | 🌐 TypeScript | 📅 2026-09-18 - Test your prompts. Evaluate and compare LLM outputs, catch regressions, and improve prompt quality.

* [Opik](https://github.com/comet-ml/opik) ⭐ 22,124 | 🐛 289 | 🌐 Python | 📅 2026-09-18 - Confidently evaluate, test, and ship LLM applications with a suite of observability tools to calibrate language model outputs across your dev and production lifecycle.

* [Guidance](https://github.com/microsoft/guidance) ⭐ 21,762 | 🐛 326 | 🌐 Jupyter Notebook | 📅 2026-05-21 — A handy looking Python library from Microsoft that uses Handlebars templating to interleave generation, prompting, and logical control.

* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,475 | 🐛 340 | 🌐 Python | 📅 2026-04-14 — An open-source library for evaluating task performance of language models and prompts.

* [MNN-LLM](https://github.com/alibaba/MNN) ⭐ 16,111 | 🐛 36 | 🌐 C++ | 📅 2026-09-18 -- A Device-Inference framework, including LLM Inference on device(Mobile Phone/PC/IOT)

* [Outlines](https://github.com/normal-computing/outlines) ⭐ 15,829 | 🐛 171 | 🌐 Python | 📅 2026-09-09 — A Python library that provides a domain-specific language to simplify prompting and constrain generation.
...
* [AI Gateway](https://github.com/Portkey-AI/gateway) ⭐ 13,030 | 🐛 269 | 🌐 TypeScript | 📅 2026-05-25 — Gateway streamlines requests to 100+ open & closed source models with a unified API. It is also production-ready with support for caching, fallbacks, retries, timeouts, loadbalancing, and can be edge-deployed for minimum latency.
...
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,925 | 🐛 308 | 🌐 Jupyter Notebook | 📅 2026-09-11 — An open-source framework to evaluate, test and monitor ML and LLM-powered systems.

* [LLocalSearch](https://github.com/nilsherzig/LLocalSearch) ⚠️ Archived - Locally running websearch using LLM chains

* [GPUStack](https://github.com/gpustack/gpustack) ⭐ 5,712 | 🐛 700 | 🌐 Python | 📅 2026-09-18 - An open-source GPU cluster manager for running LLMs
...
* [AutoRAG](https://github.com/Marker-Inc-Korea/AutoRAG) ⭐ 5,074 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-18 - Open source AutoML tool for RAG. Optimize the RAG answer quality automatically. From generation evaluation datset to deploying optimized RAG pipeline.

* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 4,814 | 🐛 1,005 | 🌐 TypeScript | 📅 2026-09-18 - Open-source LLM observability, prompt evaulation, and prompt optimzation platform.

* [Agenta](https://github.com/agenta-ai/agenta) ⭐ 4,762 | 🐛 356 | 🌐 TypeScript | 📅 2026-09-18 -  Easily build, version, evaluate and deploy your LLM-powered apps.
...
* [AdalFlow](https://github.com/SylphAI-Inc/AdalFlow) ⭐ 4,214 | 🐛 68 | 🌐 Python | 📅 2026-05-29 - AdalFlow: The library to build\&auto-optimize LLM applications.

* [Langroid](https://github.com/langroid/langroid) ⭐ 4,103 | 🐛 54 | 🌐 Python | 📅 2026-09-17 - Harness LLMs with Multi-Agent Programming

* [LazyLLM](https://github.com/LazyAGI/LazyLLM) ⭐ 3,885 | 🐛 55 | 🌐 Python | 📅 2026-09-18 - An open-source LLM app for building multi-agent LLMs applications in an easy and lazy way, supports model deployment and fine-tuning.

* [Prompttools](https://github.com/hegelai/prompttools) ⭐ 3,055 | 🐛 43 | 🌐 Python | 📅 2026-02-11 — Open-source Python tools for testing and evaluating models, vector DBs, and prompts.
...
* [llm-ui](https://github.com/llm-ui-kit/llm-ui) ⭐ 1,744 | 🐛 16 | 🌐 TypeScript | 📅 2025-07-02 - A React library for building LLM UIs.
...
* [Wllama](https://github.com/ngxson/wllama) ⭐ 1,222 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-13 - WebAssembly binding for llama.cpp - Enabling in-browser LLM inference
...
* [Robocorp](https://github.com/robocorp/robocorp) ⭐ 653 | 🐛 13 | 🌐 Python | 📅 2026-09-01 - Create, deploy and operate Actions using Python anywhere to enhance your AI agents and assistants. Batteries included with an extensive set of libraries, helpers and logging.
...
* [llm-course](https://github.com/mlabonne/llm-course) ⭐ 83,016 | 🐛 90 | 📅 2026-02-05 - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
* [LLM‑RL‑Visualized (EN)](https://github.com/changyeyu/LLM-RL-Visualized/blob/master/src/README_EN.md) ⭐ 4,895 | 🐛 3 | 🌐 Python | 📅 2026-09-10 | [LLM‑RL‑Visualized (中文)](https://github.com/changyeyu/LLM-RL-Visualized) ⭐ 4,895 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - 100+  LLM / RL Algorithm Maps📚.
...
* [Generative AI with LangChain: Build large language model (LLM) apps with Python, ChatGPT, and other LLMs](https://amzn.to/3GUlRng) - it comes with a [GitHub repository](https://github.com/benman1/generative_ai_with_langchain) ⭐ 1,422 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-14 that showcases a lot of the functionality
...
* [AutoGPT](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,435 | 🐛 576 | 🌐 Python | 📅 2026-09-18 - an experimental open-source application showcasing the capabilities of the GPT-4 language model.
...
* [EasyEdit](https://github.com/zjunlp/EasyEdit) ⭐ 2,922 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-07-14 - An easy-to-use framework to edit large language models.
* [OpenAGI](https://github.com/agiresearch/OpenAGI) ⭐ 2,284 | 🐛 10 | 🌐 Python | 📅 2024-11-28 - When LLM Meets Domain Experts.
