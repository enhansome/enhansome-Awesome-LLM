...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,402 | 🐛 210 | 🌐 Python | 📅 2025-08-28 - First open-sourced GPT-4o level model.
...
* [open-r1](https://github.com/huggingface/open-r1) ⭐ 26,441 | 🐛 340 | 🌐 Python | 📅 2026-04-02 - Fully open reproduction of DeepSeek-R1
...
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,848 | 🐛 69 | 🌐 HTML | 📅 2026-08-24 - A collection of prompt examples to be used with the ChatGPT model.

* [awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ⭐ 61,783 | 🐛 46 | 📅 2026-04-28 - A Chinese collection of prompt examples to be used with the ChatGPT model.
...
* [Chinese Large Model Leaderboard](https://github.com/jeinlee1991/chinese-llm-benchmark) ⭐ 6,395 | 🐛 18 | 📅 2026-08-23 - an expert-driven benchmark for Chineses LLMs.
...
* [DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,402 | 🐛 210 | 🌐 Python | 📅 2025-08-28
...
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,773 | 🐛 942 | 🌐 Python | 📅 2026-08-24 - A framework for few-shot evaluation of language models.
...
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,450 | 🐛 570 | 🌐 Python | 📅 2026-02-24 - a framework that helps you evaluate your Retrieval Augmented Generation (RAG) pipelines.
...
* [Megatron-LM](https://github.com/NVIDIA/Megatron-LM) ⭐ 17,561 | 🐛 1,204 | 🌐 Python | 📅 2026-08-24 - Ongoing research training transformer models at scale.
...
* [torchtitan](https://github.com/pytorch/torchtitan) ⭐ 5,660 | 🐛 682 | 🌐 Python | 📅 2026-08-24 - A native PyTorch Library for large model training.
...
* [unslothai](https://github.com/unslothai/unsloth) ⭐ 74,583 | 🐛 1,389 | 🌐 Python | 📅 2026-08-24 - A framework that specializes in efficient fine-tuning. On its GitHub page, you can find ready-to-use fine-tuning templates for various LLMs, allowing you to easily train your own data for free on the Google Colab cloud.
...
* [veRL](https://github.com/volcengine/verl) ⭐ 23,104 | 🐛 1,153 | 🌐 Python | 📅 2026-08-24 - veRL is a flexible and efficient RL framework for LLMs.
* [NeMo Framework](https://github.com/NVIDIA/NeMo) ⭐ 18,298 | 🐛 275 | 🌐 Python | 📅 2026-08-24 - Generative AI framework built for researchers and PyTorch developers working on Large Language Models (LLMs), Multimodal Models (MMs), Automatic Speech Recognition (ASR), Text to Speech (TTS), and Computer Vision (CV) domains.
* [Axolotl](https://github.com/axolotl-ai-cloud/axolotl) ⭐ 12,395 | 🐛 272 | 🌐 Python | 📅 2026-08-21 - Open-source framework for fine-tuning and evaluating LLMs. It simplifies the process of experimenting with different training configurations and makes it easy to reproduce and share results, supporting features like LoRA, QLoRA, DeepSpeed, PEFT, and multi-GPU setups.
...
* [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,371 | 🐛 126 | 🌐 Python | 📅 2026-08-24 - An Efficient and User-Friendly Scaling Library for Reinforcement Learning with Large Language Models.
* [maxtext](https://github.com/AI-Hypercomputer/maxtext) ⭐ 2,403 | 🐛 297 | 🌐 Python | 📅 2026-08-24 - A simple, performant and scalable Jax LLM!
...
* [ollama](https://github.com/ollama/ollama) ⭐ 179,315 | 🐛 3,791 | 🌐 Go | 📅 2026-08-23 - Get up and running with Llama 3, Mistral, Gemma, and other large language models.
* [llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 125,396 | 🐛 2,197 | 🌐 C++ | 📅 2026-08-24 - LLM inference in C/C++.
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 89,869 | 🐛 6,998 | 🌐 Python | 📅 2026-08-24 - A high-throughput and memory-efficient inference and serving engine for LLMs.
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 32,353 | 🐛 4,910 | 🌐 Python | 📅 2026-08-24 - SGLang is a fast serving framework for large language models and vision language models.
* [TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) ⭐ 14,462 | 🐛 1,459 | 🌐 Python | 📅 2026-08-24 - Nvidia Framework for LLM Inference
...
* [SkyPilot](https://github.com/skypilot-org/skypilot) ⭐ 10,521 | 🐛 386 | 🌐 Python | 📅 2026-08-24 - Run LLMs and batch jobs on any cloud. Get maximum cost savings, highest GPU availability, and managed execution -- all with a simple interface.
* [LMDeploy](https://github.com/InternLM/lmdeploy) ⭐ 8,017 | 🐛 610 | 🌐 Python | 📅 2026-08-24 - A high-throughput and low-latency inference and serving framework for LLMs and VLs
...
> Reference: [awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) ⭐ 133,874 | 🐛 18 | 🌐 Python | 📅 2026-08-22

* [LangChain](https://github.com/hwchase17/langchain) ⭐ 144,894 | 🐛 419 | 🌐 Python | 📅 2026-08-24 — A popular Python/JavaScript library for chaining sequences of language model prompts.
* [LlamaIndex](https://github.com/jerryjliu/llama_index) ⭐ 51,838 | 🐛 684 | 🌐 Python | 📅 2026-08-20 — A Python library for augmenting LLM apps with data.
...
* [Dify](https://github.com/langgenius/dify) ⭐ 153,361 | 🐛 965 | 🌐 TypeScript | 📅 2026-08-24 - An open-source LLM app development platform with an intuitive interface that streamlines AI workflows, model management, and production deployment.

* [Embedchain](https://github.com/embedchain/embedchain) ⭐ 63,945 | 🐛 684 | 🌐 Python | 📅 2026-08-24 - Framework to create ChatGPT like bots over your dataset.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,627 | 🐛 821 | 🌐 TypeScript | 📅 2026-08-24 -  Open Source LLM Engineering Platform 🪢 Tracing, Evaluations, Prompt Management, Evaluations and Playground.

* [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,489 | 🐛 264 | 🌐 C# | 📅 2026-08-21 — A Python/C#/Java library from Microsoft that supports prompt templating, function chaining, vectorized memory, and intelligent planning.

* [promptfoo](https://github.com/typpo/promptfoo) ⭐ 24,525 | 🐛 524 | 🌐 TypeScript | 📅 2026-08-24 - Test your prompts. Evaluate and compare LLM outputs, catch regressions, and improve prompt quality.
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,568 | 🐛 220 | 🌐 Python | 📅 2026-08-24 - Confidently evaluate, test, and ship LLM applications with a suite of observability tools to calibrate language model outputs across your dev and production lifecycle.

* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,240 | 🐛 323 | 🌐 Python | 📅 2026-04-14 — An open-source library for evaluating task performance of language models and prompts.
...
* [Outlines](https://github.com/normal-computing/outlines) ⭐ 15,679 | 🐛 166 | 🌐 Python | 📅 2026-08-24 — A Python library that provides a domain-specific language to simplify prompting and constrain generation.
...
* [AI Gateway](https://github.com/Portkey-AI/gateway) ⭐ 12,815 | 🐛 247 | 🌐 TypeScript | 📅 2026-05-25 — Gateway streamlines requests to 100+ open & closed source models with a unified API. It is also production-ready with support for caching, fallbacks, retries, timeouts, loadbalancing, and can be edge-deployed for minimum latency.
...
* [GPUStack](https://github.com/gpustack/gpustack) ⭐ 5,540 | 🐛 678 | 🌐 Python | 📅 2026-08-24 - An open-source GPU cluster manager for running LLMs

* [AutoRAG](https://github.com/Marker-Inc-Korea/AutoRAG) ⭐ 5,054 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-24 - Open source AutoML tool for RAG. Optimize the RAG answer quality automatically. From generation evaluation datset to deploying optimized RAG pipeline.
...
* [Agenta](https://github.com/agenta-ai/agenta) ⭐ 4,524 | 🐛 282 | 🌐 TypeScript | 📅 2026-08-24 -  Easily build, version, evaluate and deploy your LLM-powered apps.
...
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,505 | 🐛 811 | 🌐 TypeScript | 📅 2026-08-24 - Open-source LLM observability, prompt evaulation, and prompt optimzation platform.
...
* [llm-course](https://github.com/mlabonne/llm-course) ⭐ 81,955 | 🐛 88 | 📅 2026-02-05 - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
* [LLM‑RL‑Visualized (EN)](https://github.com/changyeyu/LLM-RL-Visualized/blob/master/src/README_EN.md) ⭐ 4,811 | 🐛 3 | 🌐 Python | 📅 2026-07-27 | [LLM‑RL‑Visualized (中文)](https://github.com/changyeyu/LLM-RL-Visualized) ⭐ 4,811 | 🐛 3 | 🌐 Python | 📅 2026-07-27 - 100+  LLM / RL Algorithm Maps📚.
...
* [AutoGPT](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,849 | 🐛 536 | 🌐 Python | 📅 2026-08-24 - an experimental open-source application showcasing the capabilities of the GPT-4 language model.
